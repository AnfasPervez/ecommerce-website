...
?>
  ...
  //  $brand_id = $_POST[' $brand_id'];
	...
	// 	mysqli_query($conn, "INSERT INTO product (product_name, product_desc , brand_id) VALUES ('$product_name','$product_desc ', '$brand_id')"); 
...
src="https://code.jquery.com/jquery-3.4.1.js"
  ...
  // document.getElementById('btn').addEventListener(onclick,function(){session_destroy();})
...
//      $edit_desc=$(this).parent();
//      $edit_brand=$(this).parent();
...
//     $('#product_desc').val('');
//     $('#brand_id').val('');
//     $edit_name.replaceWith(response);
//     $edit_desc.replaceWith(response);
//     $edit_desc.replaceWith(response);
//   }
