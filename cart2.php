...
<div  class="container">
  ...
  <hr>
  <button type="button" style="margin-top:30px; left:0px; " class="ser-btn" ><a href="logout.php" style="text-decoration:none">logout</a></button>
  <?php 
...
<div id="emptyCart" style="<?=$emptyCss?>">
       ...
       <p><strong>Your cart is empty. <a href="index.php">Click here</a>to shop
       </strong></p>
